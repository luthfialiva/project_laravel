...
@section('content')
        ...
        <section class="content">
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Data Table Reminder</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @for($i = 0; $i < count($docs); $i++)
                                        ...
                                        <td>
                                            @if(Auth::User()->role == 1)
                                                <div class="btn-group">
                                                    <a class="btn btn-info btn-sm dropdown-toggle" data-toggle="dropdown" href="#">Actions <span class="caret"></span></a>
                                                    <ul class="dropdown-menu">
                                                        <li><a href="{{route('reminder.edit', ['id' => $docs[$i]->id])}}"><i class="glyphicon glyphicon-pencil"></i> Edit</a></li>
                                                        <li><a data-toggle="modal" data-target="#basicModal-{{ $docs[$i]->id }}"><i class="glyphicon glyphicon-trash"></i> Delete</a></li>
                                                        <li><a href="{{route('reminder.show', ['id' => $docs[$i]->id])}}"><i class="glyphicon glyphicon-search"></i> Details</a></li>
                                                    </ul>
                                                </div>
                                            ...
                                            @else
                                                <button onclick="window.location.href='{{route('reminder.edit', ['id' => $docs[$i]->id])}}'" class="btn btn-primary btn-sm">Edit</button>
                                                ||
            ...
            <button onclick="window.location.href='{{route('reminder.create')}}'" class="btn btn-primary"><span class="glyphicon glyphicon-plus-sign"></span> Tambah Dokumen Kontrak Kerja</button>
@endsection
