        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li>
                        <a href="{{route('admin.index')}}"><i class="fa fa-home"></i> Home </i></a>
                    </li>
                    <li>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="{{action('ReminderController@history')}}"><i class="fa fa-table"></i> History</a></li>
                    ...
                    <li>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="{{action('AdminController@act')}}"><i class="fa fa-table"></i> Activity</a></li>
