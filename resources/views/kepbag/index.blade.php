...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="{{route('kepbag.index')}}"><i class="fa fa-dashboard"></i> Home</a></li>
    ...
    <section class="content">
        ...
        <div class="pad margin no-print">
            <div class="callout callout-info" style="margin-bottom: 0!important;">
                ...
                Selamat Datang {{ Auth::User()->name }}, sebagai Kepala Bagian untuk fitur User Management disable !!!
            </div>
        </div>
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="box box-default">
                    ...
                    <div class="box-footer no-padding">
                        <ul class="nav nav-pills nav-stacked">
                            <li><a href="{{route('admin.all')}}">Member User <span class="pull-right text-yellow"> {{ App\User::paginate(15)->total()}}</span></a></li>
                            <li><a href="{{route('reminder.index')}}">Dokumen Kontrak Kerja <span class="pull-right text-aqua"> {{ App\Doc::paginate(15)->total()}}</span></a></li>
                            <li><a href="{{route('bidang.index')}}">Bidang Operasional <span class="pull-right text-green"> {{ App\Bidang::paginate(15)->total()}}</span></a></li>
                            <li><a href="{{route('kategori.index')}}">Kategori Dokumen<span class="pull-right text-red"> {{ App\Kategori::paginate(15)->total()}}</span></a></li>
                        </ul>
                    </div><!-- /.footer -->
                </div><!-- /.box -->
                <!-- PRODUCT LIST -->
